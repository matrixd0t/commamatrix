...
class RunCtx:
    ...
    origin, user identity, iteration count, persistence mode, instruction aggregation,
    and mutable state dict."""
    ...
    """Whether dynamic ``@instruction`` handlers run before LLM calls."""
