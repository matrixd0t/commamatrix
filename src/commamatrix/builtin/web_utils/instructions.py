...
- Fetch relevant primary sources with 'web.fetch'. If you know a site provides a direct data/API endpoint (e.g. PyPI JSON API at /pypi/{name}/json, GitHub API at api.github.com, or any structured data endpoint), prefer fetching it directly.
